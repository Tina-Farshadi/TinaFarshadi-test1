...
task_entry = tk.Entry(frame_input, width=40, font=("Times New Roman", 14))
task_entry.pack(side=tk.LEFT, padx=5)


task_listbox = tk.Listbox(root, width=46, height=12, selectmode=tk.SINGLE, font=("Times New Roman", 14))
